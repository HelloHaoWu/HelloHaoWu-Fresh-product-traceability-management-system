  ...
  <div class = 'all_page'>
    ...
    <el-card class = 'deliverTable'>
      <el-table
          ...
          style="width: 100%"
      >
        <el-table-column prop="Delivery_ID" label="配送编号" sortable width="180" />
        <el-table-column prop="Order_ID_id" label="订单编号" width="180" />
        <el-table-column prop="Latest_Delivery_Time" label="最晚送达时间" width="180" />
